...
const PostApplication = () => {
  ...
  // Initialize form fields to safe default values, ensuring no undefined values
  ...
  useEffect(() => {
    if (user) {
      ...
      setResume(user.resume?.url || ""); // Ensure it's an empty string if not available
    }
  ...
  if (Array.isArray(singleJob.qualifications)) {
    qualifications = singleJob.qualifications;
  } else if (
    singleJob.qualifications &&
    typeof singleJob.qualifications === "string"
  ) {
    qualifications = singleJob.qualifications.split(". ");
  }

  if (Array.isArray(singleJob.responsibilities)) {
    responsibilities = singleJob.responsibilities;
  } else if (
    singleJob.responsibilities &&
    typeof singleJob.responsibilities === "string"
  ) {
    responsibilities = singleJob.responsibilities.split(". ");
  }

  if (Array.isArray(singleJob.offers)) {
    offering = singleJob.offers;
  } else if (singleJob.offers && typeof singleJob.offers === "string") {
